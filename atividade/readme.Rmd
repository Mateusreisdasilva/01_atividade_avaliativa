...
**item-03_Calculo dos quartiles_** </br> Pegando como base os dados da variável (X) que representam os (BAT/min) foi possível analisar os valores do _PRRIMEIRO QUARTIL E TERCEIRO QUARTIL_ como solicitado na atividade, depois de usar a função _quantil_, observou-se os valores dispostos abaixo. 
